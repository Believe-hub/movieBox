...
async function getMovieDetails(id) {
    ...
    if(trailer){
        ...
        movieBox.innerHTML = `
            ...
            // const movieDetails = document.querySelector('.container1')
            movieBox.innerHTML += `<div class="container1">
                <div class="movie-report">
                        ...
                        <div class="rate"> <span class="ratings">&#11088 ${data.vote_average}</span> | ${data.vote_count}</div>
                    </div>
                    <div class="movie-article">
                        <div class="article">
                            ...
                            <div class="more">
                                ...
                                <div class="drop"><i class="fa fa-chevron-down" aria-hidden="true"></i>
                                </div>
                            </div>
                        </div>
                        <div class="notice">
                            ...
                            <div class="img">
                                ...
                                <!-- <div class="opacity">The best movies and show on september</div> -->
                            </div>
                        </div>
                    </div>
                    </div>`;
